def cropcalendar(domain_path, basepath, referenceraster_path):
    ...
    # THIS SCRIPT COULD BE EXTENDED BY MANUAL DELAY OF PLANTING DATE USING RAINFALL THRESHOLDS (min. 10 mm rainfall/month), TO AVOID DYING OF CROPS WHEN PLANTED TOO EARLY (HAPPENS A LOT IN THE MEKONG WHEN USING DEFAULT CROP CALENDAR)
